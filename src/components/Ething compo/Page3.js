...
export default function ThirdPage() {
  ...
  let [OrigArray] = useState([
    "abcnews.go.com", "abc.net.au/news", "aftenposten.no", "aljazeera.com", "ansa.it",
    "argaam.com", "arstechnica.com", "arynews.tv", "apnews.com", "afr.com", "axios.com",
    "bbc.co.uk/news", "bbc.co.uk/sport", "bild.de", "br.blastingnews.com", "bleacherreport.com",
    "bloomberg.com", "breitbart.com", "businessinsider.com", "buzzfeed.com", "cbc.ca/news",
    "cbsnews.com", "edition.cnn.com", "cnnespanol.cnn.com", "ccn.com", "tagesspiegel.de",
    "zeit.de", "elmundo.es", "engadget.com", "ew.com", "espn.com", "espncricinfo.com",
    "financialpost.com", "focus.de", "football-italia.net", "fortune.com", "fourfourtwo.com",
    "foxnews.com", "foxsports.com", "g1.globo.com", "news.google.com", "news.google.com.ar",
    "news.google.com.au", "news.google.com.br", "news.google.ca", "news.google.fr",
    "news.google.co.in", "news.google.is", "news.google.it", "news.google.ru",
    "news.google.com.sa", "news.google.co.uk", "gp.se", "gruenderszene.de",
    "news.ycombinator.com", "handelsblatt.com", "ign.com", "ilsole24ore.com",
    "independent.co.uk", "infobae.com", "infomoney.com.br", "lagaceta.com.ar",
    "lanacion.com.ar", "repubblica.it", "lemonde.fr", "lenta.ru", "lequipe.fr",
    "lesechos.fr", "liberation.fr", "marca.com", "mashable.com", "medicalnewstoday.com",
    "msnbc.com", "mtv.com/news", "mtv.co.uk/news", "nationalgeographic.com",
    "nationalreview.com", "nbcnews.com", "news24.com", "newscientist.com", "news.com.au",
    "newsweek.com", "nymag.com", "nextbigfuture.com", "nfl.com", "nhl.com", "nrk.no",
    "politico.com", "polygon.com", "rbc.ru", "recode.net", "reddit.com", "reuters.com",
    "rt.com", "rte.ie", "rtlnieuws.nl", "sabq.org", "spiegel.de", "svd.se", "t3n.de",
    "talksport.com", "techcrunch.com", "techcrunch.cn", "techradar.com",
    "theamericanconservative.com", "theglobeandmail.com", "thehill.com", "thehindu.com",
    "huffpost.com", "irishtimes.com", "jpost.com", "ladbible.com", "thenextweb.com",
    "thesportbible.com", "timesofindia.indiatimes.com", "theverge.com", "wsj.com",
    "washingtonpost.com", "washingtontimes.com", "time.com", "usatoday.com", "vice.com",
    "wired.com", "wired.de", "wiwo.de", "xinhuanet.com", "ynet.co.il"
  ]);
  ...
  function SelectFunc1(ix, check) {
    ...
    if (check === 1 ? !shikaar.checked : shikaar.checked) {
      ...
      setSourceArray(SourceArray.filter((value) => Value !== value));
    } else {
  ...
  function SelectFunc2(ix, check) {
    ...
    if (check === 1 ? !shikaar.checked : shikaar.checked) {
      shikaar.checked = false;
      setexcludeDomainArray(excludeDomainArray.filter((value) => Value !== value));
    } else {
      shikaar.checked = true;
  ...
  return (
    <div>
      {Choose === 0 ? (
        <div className="center" style={{ position: "relative" }}>
          ...
          <div className="OptionDiv" style={{ ...StyleOfOptionDiv2, borderRadius: '12px' }}>
            <div className="Options" onClick={() => setChoose(1)}>
              Select domain(s) from which you want news articles
            </div>
            <div className="Options" onClick={() => setChoose(2)}>
      ...
      {Choose === 0 ? null : Choose === 1 ? (
        <div>
          <button className="center btn" onClick={() => setChoose(0)} style={{ marginBottom: '25px' }}>
            Choose Again
          </button>
          <label htmlFor="InputSources" className="labelVertical">
            ...
            <div className="VerticalLabel">
              <b style={{ wordBreak: "break-word" }}>
                {SourceArray.length === 0 ? null : "&domains="}
                {SourceArray.map((val, ix) => (ix >= 1 ? "," + val : val))}
              </b>
            </div>
          </label>
            ...
            <input
              ...
              onClick={() => {
                if (SelectTag1 === 1) {
                  ...
                  setSelectTag1(1);
                  setStyleOfOptionDiv({ ...StyleOfOptionDiv, display: "block" });
            ...
            <div className="OptionDiv" style={StyleOfOptionDiv}>
              {SourcesArray.length === 0 ? (
                ...
                SourcesArray.map((SourceName, ix) => {
                  let check = SourceArray.includes(SourceName) ? 1 : 0;
                  return (
                    <div className="Options" onClick={() => SelectFunc1(ix, 0)} key={SourceName}>
                      <input
                        type="checkbox"
                        checked={check === 1}
        ...
        <div>
          ...
          <label htmlFor="InputSources" className="labelVertical">
            ...
            <div className="VerticalLabel">
              <b style={{ wordBreak: "break-word" }}>
                {excludeDomainArray.length === 0 ? null : "&excludeDomains="}
                {excludeDomainArray.map((val, ix) => (ix >= 1 ? "," + val : val))}
              </b>
            </div>
          </label>
          <div style={{ position: "relative" }}>
            <input
              ...
              onClick={() => {
                if (SelectTag3 === 1) {
                  ...
                  setSelectTag3(1);
                  setStyleOfOptionDiv3({ ...StyleOfOptionDiv3, display: "block" });
            ...
            <div className="OptionDiv" style={StyleOfOptionDiv3}>
              {excludeDomainsArray.length === 0 ? (
                ...
                excludeDomainsArray.map((SourceName, ix) => {
                  let check = excludeDomainArray.includes(SourceName) ? 1 : 0;
                  return (
                    <div className="Options" onClick={() => SelectFunc2(ix, 0)} key={SourceName}>
                      <input
                        type="checkbox"
                        checked={check === 1}
